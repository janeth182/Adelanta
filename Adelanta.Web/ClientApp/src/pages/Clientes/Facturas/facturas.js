...
export const FacturasPage = () => {
  ...
  const columns = [
    ...
    {
      title: "IGV",
      dataIndex: "importeIGV",
      ...getColumnSearchProps("importeIGV"),
    },
    {
      title: "Total",
          ...
          <>
            <Space>
              <Button
                type="link"
                href={MyPDF}
                download="FACTURAE001-32.pdf"
                danger
                icon={
                  <FilePdfOutlined style={{ fontSize: "16px", color: "red" }} />
                }
              >
                PDF
              </Button>
              <Button
                type="link"
                href={MyXML}
                download="20514535222-01-F001-00004348.xml"
                info
                icon={
                  <FileTextOutlined
      ...
      <Row>
        <Col span={24}>
          <Card
            title="Facturas"
            actions={[]}
            extra={<ExportCSV csvData={data} fileName={"Facturas"} />}
          >
            <Table
              loading={loadingApi}
              columns={columns}
      ...
      >
        <Form layout="vertical" className="ant-advanced-search-form">
          <Descriptions title="Datos Principales">
            <Descriptions.Item label="Liquidacion" span={2}>
              LIQ-0004-2021
            </Descriptions.Item>
            <Descriptions.Item label="Fecha" span={2}>
              22/10/2021
            </Descriptions.Item>
            <Descriptions.Item label="Cedente" span={2}>
              ISI Group S.A.C
            </Descriptions.Item>
            <Descriptions.Item label="Pagador" span={2}>
              Rimac
            </Descriptions.Item>
            <Descriptions.Item label="Tipo de Operación" span={2}>
              Factoring
            </Descriptions.Item>
          </Descriptions>
          <Table
