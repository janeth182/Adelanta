...
import { respuesta }from "../../../model/mocks/pagador";
import { ExportCSV } from '../../../utils/excel';

export const PagadorPage = () => {
	...
	const columns = [
		...
		},
        {
			title: "% TNM",
			dataIndex: "perTnm",
			...getColumnSearchProps("perTnm"),   	
		},
        {
			title: "% TNA",
			dataIndex: "perTna",
			...getColumnSearchProps("perTna"),   	
		},
        {
			title: "% Financiamiento",
			dataIndex: "perFinanciamiento",
			...getColumnSearchProps("perFinanciamiento"),   	
		},
        {
			title: "Acción",
			dataIndex: "actiion",
	...
	return (
		<ContentComponent>
			...
			<Row>
				<Col span={24}>
					<Card
						title="Clientes Pagadores Registrados"
						actions={[]}
						extra={
							<>
							 <Space>
